...
<svg viewBox="0 0 1400 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <g id="rectSent" clip-path="url(#clipPath)">
    <g id="rectSentItems">
      ...
      <text id="txtSent" fill="#4F67ED" xml:space="preserve" style="white-space: pre" font-family="Roboto" font-size="82" font-weight="bold" letter-spacing="0.025em"><tspan x="637.487" y="568.027">Wysłane</tspan></text>
    </g>
  </g>
  <g id="base">
    <g filter="url(#flShadow)"><rect id="btnBase" x="418.117" y="460.55" width="583.765" height="158.899" rx="23" fill="#F1F3FF" /></g>
      <text id="txtSend" fill="#291D89" xml:space="preserve" style="white-space: pre" font-family="Roboto" font-size="82" font-weight="bold" letter-spacing="0.06em"><tspan x="679.379" y="568.027">Wyślij</tspan></text>
  ...
  <!-- GSAP główna biblioteka -->
<script src="https://unpkg.com/gsap@3/dist/gsap.min.js"></script>
<!-- Hammer do obsłógi dotyku ekranu -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/hammer.js/2.0.8/hammer.min.js"></script>
<script src="https://unpkg.com/gsap@3/dist/MotionPathPlugin.min.js"></script>

<script src="pokazzdj.js"></script>
<script src="odliczanie.js"></script>
<!--<script src="responsywnakaruzela.js"></script>-->
